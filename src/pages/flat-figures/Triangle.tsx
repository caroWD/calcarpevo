...
import diagram from '@/assets/diagram-triangle-geometric-figure.svg'
    ...
    <Layout>
      <Main>
        <ResultContextProvider>
          {step === 0 ? (
            <FigureInfo
              figureType="Triángulo"
              figureImage={diagram}
              alternativeText="Diagrama de figura geometrica triángular"
            ...
            <FormContextProvider nextStep={nextStep}>
              <FigureForm type="triangle">
                ...
                <NumberField key={3} label="Defina 'c' (base)" name="sideC" placeholder="ej. 75" />
