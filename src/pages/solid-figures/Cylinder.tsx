...
import diagram from '@/assets/diagram-cylinder-geometric-figure.svg'
        ...
        <ResultContextProvider>
          {step === 0 ? (
            <FigureInfo
              figureType="Cilindro"
              figureImage={diagram}
              alternativeText="Diagrama de figura geometrica cilindrica"
              volumeFormula="V => Pi * r ** 2 * h"
              onClick={nextStep}
            />
          ) : step === 1 ? (
            <FormContextProvider nextStep={nextStep}>
              <FigureForm type="cylinder" figure="cilindro">
