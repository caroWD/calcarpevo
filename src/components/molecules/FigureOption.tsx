...
const FigureOption = ({ label, link, icon }: Props) => {
  const navLinkStyles: string =
    icon === 'cone'
      ? 'flex flex-col justify-center items-center gap-1.5 border-2 border-indigo-950 rounded-2xl last:col-span-2'
      : 'flex flex-col justify-center items-center gap-1.5 border-2 border-indigo-950 rounded-2xl'
  return (
